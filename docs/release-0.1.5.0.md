LiveDrop 0.1.5.0 is the known-good baseline for local testing.
...
This version is a known-good local baseline; physical Android and Windows peer testing remains required before publishing a GitHub release.
